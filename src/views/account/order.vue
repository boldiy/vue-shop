    ...
    <div class="account-content">
        <div class="account-order">
            <div class="gray-box">
                ...
                <div class="js-list-inner">
                    <div class="box-inner order-cart order-list-cart clear" v-for="order, index in orderList">
                        <div
                            style="display: flex;height:50px;align-items: center;padding: 24px;border-bottom: solid 1px #d7d7d7;">
                            <span style="width:25%"> 订单号：{{ order.OrderCode }}</span>
                            <span style="width:20%">金额：{{ order.OrderPrice }}</span>
                            <span style="width:20%"> {{ order.OrderStatusCode }}</span>
                            <span style="width:20%">{{ order.iDate }}</span>
                            <span style="width:20%">
                                <el-button type="primary" @click="orderClick(order)">查看详情</el-button>
                            </span>
                        </div>
                    </div>
                </div>
            ...
            <el-dialog title="收货地址" :visible.sync="dialogFormVisible">
                <el-form :model="currentOrder" inline label-width="100px">
                    <el-form-item label="订单号" style="width: 100%;">
                        <el-input v-model="currentOrder.OrderCode" readonly style="width:300px;"></el-input>
                    </el-form-item>
                    <el-form-item label="收货人" style="width: 100%;">
                        <el-input v-model="currentOrder.UserName" readonly style="width:300px;"></el-input>
                    </el-form-item>
                    <el-form-item label="收货地址" style="width: 100%;">
                        <el-input v-model="currentOrder.Address" readonly style="width:300px;"></el-input>
                    </el-form-item>
                </el-form>

                <el-table :data="currentOrder.detail" stripe style="width: 100%">
                    <el-table-column prop="productName" label="产品名称" width="180"></el-table-column>
                    <el-table-column prop="productQty" label="产品数量" width="180"></el-table-column>
...
export default {
    ...
    methods: {
        loadingOrder() {
            axios.post("http://localhost:8001/api/OrderBasic/QueryEntityList", {}, response => {
