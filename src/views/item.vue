            ...
            <div class="item-box">
                <div class="gallery-wrapper">
                    <div class="gallery">
                        <div class="thumbnail">
                            <ul>
                                <li :class="{ 'on': index == 0 }" key="index" v-for="img, index in itemsInfo.ali_images"
                                    :key="index"><img
                    ...
                    <div class="sku-dynamic-params-panel">
                        <div class="sku-dynamic-params clear">
                            ...
                            <ul class="params-colors">
                                <li :class="{ 'cur': color.id == $route.query.itemId }"
                                    v-for="(color, index) in itemsInfo.sku_list" :key="index">
                                    <router-link :to="{ name: 'Item', query: { itemId: color.id } }"
                                        :title="color.color"><i></i></router-link>
                                </li>
                            </ul>
                        </div>
                        <div class="sku-dynamic-params clear">
                            ...
                            <div class="params-detail clear">
                                <div class="item-num js-select-quantity">
                                    <span class="down" :class="{ 'down-disabled': count <= 1 }"
                                        @click="subCount">-</span>
                                    <span class="num">{{ count }}</span>
                                    <span class="up" :class="{ 'up-disabled': count >= itemsInfo.limit_num }"
                                        @click="addCount">+</span>
                                </div>
                            </div>
                        </div>
...
export default {
    ...
    methods: {
        ...
        //添加购物车
        addCarPanelHandle() {
            axios.post("http://localhost:8001/upload/list", { productID: 12, qty: 1 }, response => {
